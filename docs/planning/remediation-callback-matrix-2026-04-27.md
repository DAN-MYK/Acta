...
> **Archived/pre-cutover:** матриця фіксує Slint callback contract до Tauri cutover. Для live invoke/store contract використовуй `docs/architecture/tauri-command-surface.md` і `frontend/src/lib/*`; посилання на `src/ui/*` тут історичні.
