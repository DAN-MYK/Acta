...
- [ ] **Step 2: Run `npm run test:frontend -- browser-api.test.ts` and confirm the fallback path is missing**
- [ ] **Step 3: Implement browser-only invoke fallback with stable fixture DTOs for shell, documents, counterparties, payments, reports, settings, dashboard, tasks, palette and BAS import**
- [ ] **Step 4: Re-run `npm run test:frontend -- browser-api.test.ts` and confirm green**
...
- [ ] **Step 1: Write failing tests for Ukrainian shell labels, `Esc` close behavior, disabled shell actions during reload, and palette reset semantics**
- [ ] **Step 2: Run `npm run test:frontend -- App.test.ts` and confirm the new expectations fail**
- [ ] **Step 3: Replace broken microcopy, harden shell busy-state gating, and keep palette state deterministic between opens/closes**
- [ ] **Step 4: Re-run `npm run test:frontend -- App.test.ts` and confirm green**
...
- [ ] **Step 1: Write failing tests for Ukrainian reports microcopy, canonical button classes, and localized density labels/settings integration states**
- [ ] **Step 2: Run targeted Vitest commands and confirm failures**
- [ ] **Step 3: Implement canonical actions, localized labels, scenario-first copy, and cleaner BAS/settings action rows**
...
- [ ] **Step 1: Write failing tests for date field types, action hierarchy classes, and stronger payment/document CTA wording**
- [ ] **Step 2: Run the two screen test files and confirm failures**
- [ ] **Step 3: Convert date controls to canonical inputs, apply button hierarchy consistently, and improve action wording/layout**
- [ ] **Step 4: Re-run the targeted tests until green**
...
- [ ] **Step 1: Run `npm run test:frontend`**
- [ ] **Step 2: Run `npm run check`**
- [ ] **Step 3: Run `npm run build`**
- [ ] **Step 4: Reload `http://127.0.0.1:1420/` in the in-app browser and visually verify shell, reports, settings, documents and payments**
- [ ] **Step 5: Report verified outcomes and any residual gaps with explicit evidence**
