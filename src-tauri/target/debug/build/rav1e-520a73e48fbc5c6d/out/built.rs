...
#[allow(dead_code)]
pub static RUSTC: &str = "C:\\Users\\MykhailoDan\\.rustup\\toolchains\\stable-x86_64-pc-windows-gnu\\bin\\rustc.exe";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "C:\\Users\\MykhailoDan\\.rustup\\toolchains\\stable-x86_64-pc-windows-gnu\\bin\\rustdoc.exe";
#[allow(clippy::needless_raw_string_hashes)]
...
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `C:\Users\MykhailoDan\.rustup\toolchains\stable-x86_64-pc-windows-gnu\bin\rustc.exe -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.94.1 (e408947bf 2026-03-25)";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `C:\Users\MykhailoDan\.rustup\toolchains\stable-x86_64-pc-windows-gnu\bin\rustdoc.exe -V`; empty string if `C:\Users\MykhailoDan\.rustup\toolchains\stable-x86_64-pc-windows-gnu\bin\rustdoc.exe -V` failed to execute"#]
#[allow(dead_code)]
