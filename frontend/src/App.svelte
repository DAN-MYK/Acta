<script lang="ts">
  ...
  const settingsSectionsPrimary: Array<[SettingsSection, string]> = [
...
<div class="app-shell">
  ...
  <main class="content">
            ...
            {#if $settings.section === "appearance"}
              <div class="settings-card">
                ...
                <div class="settings-actions-row">
                  ...
                  <select
                    value={$settings.screen?.preferences.density ?? 1}
                    on:change={onSettingsDensityChange}
                  >
    ...
    {#if currentScreen === "documents" && $documents.editor}
    ...
    {#if currentScreen === "counterparties" && $counterparties.editor}
      <section class="editor-sheet">
        <div class="editor-header">
          <div>
    ...
    {#if currentScreen === "payments" && $payments.editor}
      <section class="editor-sheet">
        <div class="editor-header">
          <div>
